...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/hello_world_testingggg/helpers/` and `examples/` directory.
...
require_relative "../lib/hello_world_testingggg"
...
```ruby
gem "hello-world-testingggg", path: "<path-to-repo>"
```
