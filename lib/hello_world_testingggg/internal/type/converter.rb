    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { HelloWorldTestingggg::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { HelloWorldTestingggg::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            HelloWorldTestingggg::FilePart.new(value)
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in HelloWorldTestingggg::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [HelloWorldTestingggg::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: HelloWorldTestingggg::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in HelloWorldTestingggg::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in HelloWorldTestingggg::Internal::Type::Converter
              ...
              HelloWorldTestingggg::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(HelloWorldTestingggg::Internal::Type::Converter, T::Class[T.anything]) }
        end
