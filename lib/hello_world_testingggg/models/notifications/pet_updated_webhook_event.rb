  ...
  module Models
    module Notifications
      class PetUpdatedWebhookEvent < HelloWorldTestingggg::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Symbol, HelloWorldTestingggg::Models::Notifications::PetUpdatedWebhookEvent::ChangedField>]
        required :changed_fields,
                 -> { HelloWorldTestingggg::Internal::Type::ArrayOf[enum: HelloWorldTestingggg::Notifications::PetUpdatedWebhookEvent::ChangedField] }
        ...
        # @!attribute type
        #
        #   @return [Symbol, HelloWorldTestingggg::Models::Notifications::PetUpdatedWebhookEvent::Type]
        required :type, enum: -> { HelloWorldTestingggg::Notifications::PetUpdatedWebhookEvent::Type }
        ...
        #   @param changed_fields [Array<Symbol, HelloWorldTestingggg::Models::Notifications::PetUpdatedWebhookEvent::ChangedField>]
        #
        #   @param pet [HelloWorldTestingggg::Models::PetAPI]
        #
        #   @param type [Symbol, HelloWorldTestingggg::Models::Notifications::PetUpdatedWebhookEvent::Type]
        #
        ...
        # @see HelloWorldTestingggg::Models::Notifications::PetUpdatedWebhookEvent#type
        module Type
          extend HelloWorldTestingggg::Internal::Type::Enum
