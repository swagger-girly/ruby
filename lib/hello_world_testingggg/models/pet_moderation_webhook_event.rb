  ...
  module Models
    module PetModerationWebhookEvent
      ...
      class PetModerationRejected < HelloWorldTestingggg::Internal::Type::BaseModel
        ...
        # @!attribute reason
        #
        #   @return [Symbol, HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::Reason]
        required :reason,
                 enum: -> { HelloWorldTestingggg::PetModerationWebhookEvent::PetModerationRejected::Reason }
        ...
        #
        #   @return [Array<HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::ReviewNote>, nil]
        optional :review_notes,
                 -> { HelloWorldTestingggg::Internal::Type::ArrayOf[HelloWorldTestingggg::PetModerationWebhookEvent::PetModerationRejected::ReviewNote] }

        # @!method initialize(pet:, reason:, review_notes: nil, type: :"pet.moderation.rejected")
        #   @param pet [HelloWorldTestingggg::Models::PetAPI]
        #   @param reason [Symbol, HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::Reason]
        #   @param review_notes [Array<HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::ReviewNote>]
        #   @param type [Symbol, :"pet.moderation.rejected"]

        # @see HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected#reason
        module Reason
        ...
        class ReviewNote < HelloWorldTestingggg::Internal::Type::BaseModel
          ...
          # @!attribute reviewer
          #
          #   @return [HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::ReviewNote::Reviewer, nil]
          optional :reviewer,
          ...
          #   @param reviewer [HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::ReviewNote::Reviewer]

          # @see HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected::ReviewNote#reviewer
      ...
      #   @return [Array(HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationApproved, HelloWorldTestingggg::Models::PetModerationWebhookEvent::PetModerationRejected)]
    end
  end
end
