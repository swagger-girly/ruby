  ...
  module Models
    module Store
      ...
      class OrderRetrieveResponse < HelloWorldTestingggg::Internal::Type::BaseModel
        ...
        # @!method initialize(id: nil, complete: nil, pet_id: nil, quantity: nil, related_address: nil, related_category: nil, related_customer: nil, related_money: nil, related_pet: nil, related_shelter: nil, related_tag: nil, related_user: nil, ship_date: nil, status: nil, total: nil)
        #   @param id [Integer]
        #
        ...
        # Order Status
        #
        # @see HelloWorldTestingggg::Models::Store::OrderRetrieveResponse#status
        module Status
