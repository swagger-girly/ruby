...
module HelloWorldTestingggg
  module Models
    ...
    class UserCreateParams < HelloWorldTestingggg::Internal::Type::BaseModel
      ...
      # @!method initialize(id: nil, email: nil, first_name: nil, last_name: nil, password: nil, phone: nil, related_address: nil, related_category: nil, related_customer: nil, related_money: nil, related_order: nil, related_pet: nil, related_shelter: nil, related_tag: nil, username: nil, user_status: nil, request_options: {})
      #   @param id [Integer]
      #
      #   @param email [String]
      #
