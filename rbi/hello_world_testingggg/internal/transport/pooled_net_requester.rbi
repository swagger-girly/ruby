      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                HelloWorldTestingggg::Internal::Transport::PooledNetRequester::Request,
        ...
        def self.new(
          size: HelloWorldTestingggg::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
