  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            HelloWorldTestingggg::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        sig do
          params(
            parsed: HelloWorldTestingggg::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: HelloWorldTestingggg::Internal::Util::ParsedUri,
            rhs: HelloWorldTestingggg::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: HelloWorldTestingggg::Internal::AnyHash).returns(
            HelloWorldTestingggg::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: HelloWorldTestingggg::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[HelloWorldTestingggg::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  HelloWorldTestingggg::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
