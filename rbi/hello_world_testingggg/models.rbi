...
module HelloWorldTestingggg
  ...
  AdoptionRetrieveDecisionParams =
    HelloWorldTestingggg::Models::AdoptionRetrieveDecisionParams
  ...
  ClientRetrieveRateLimitsParams =
    HelloWorldTestingggg::Models::ClientRetrieveRateLimitsParams

  File = HelloWorldTestingggg::Models::File

  FileCreateArchiveParams =
    HelloWorldTestingggg::Models::FileCreateArchiveParams
  ...
  PetInventoryLowWebhookEvent =
    HelloWorldTestingggg::Models::PetInventoryLowWebhookEvent

  PetListFakePageInferredParams =
    HelloWorldTestingggg::Models::PetListFakePageInferredParams
  ...
  PetListUnpaginatedParams =
    HelloWorldTestingggg::Models::PetListUnpaginatedParams

  PetModerationWebhookEvent =
    HelloWorldTestingggg::Models::PetModerationWebhookEvent
  ...
  PetUpdateWithFormParams =
    HelloWorldTestingggg::Models::PetUpdateWithFormParams
  ...
  PlacementEventRecordedWebhookEvent =
    HelloWorldTestingggg::Models::PlacementEventRecordedWebhookEvent

  PlacementListParams = HelloWorldTestingggg::Models::PlacementListParams

  PlacementRecordEventParams =
    HelloWorldTestingggg::Models::PlacementRecordEventParams

  PlacementRetrieveParams =
    HelloWorldTestingggg::Models::PlacementRetrieveParams
  ...
  ProfileLegacySearchParams =
    HelloWorldTestingggg::Models::ProfileLegacySearchParams
  ...
  StoreListInventoryParams =
    HelloWorldTestingggg::Models::StoreListInventoryParams
  ...
  UserCreateWithListParams =
    HelloWorldTestingggg::Models::UserCreateWithListParams
