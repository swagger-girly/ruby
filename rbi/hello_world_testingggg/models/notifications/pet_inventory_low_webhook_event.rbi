  ...
  module Models
    module Notifications
      class PetInventoryLowWebhookEvent < HelloWorldTestingggg::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          returns(
            T.nilable(
              HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::LastOrder
            )
          )
        end
        ...
        sig do
          params(
            last_order:
              HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::LastOrder::OrHash
          ).void
        end
        ...
        sig do
          params(
            ...
            threshold: Integer,
            type:
              HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::Type::OrSymbol,
            last_order:
              HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::LastOrder::OrHash,
            locations: T::Array[HelloWorldTestingggg::Address::OrHash]
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::Type
              )
            end
        ...
        class LastOrder < HelloWorldTestingggg::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::LastOrder::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::LastOrder::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HelloWorldTestingggg::Notifications::PetInventoryLowWebhookEvent::LastOrder::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
