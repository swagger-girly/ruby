  ...
  module Models
    class UserCreateWithListParams < HelloWorldTestingggg::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            HelloWorldTestingggg::UserCreateWithListParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[HelloWorldTestingggg::UserCreateWithListParams::Body]
          )
        )
      end
      attr_reader :body
      ...
      class Body < HelloWorldTestingggg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              HelloWorldTestingggg::UserCreateWithListParams::Body,
              HelloWorldTestingggg::Internal::AnyHash
            )
          end
