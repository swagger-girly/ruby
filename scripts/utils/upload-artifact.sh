...
echo -e "\033[32mInstallation: bundle remove hello-world-testingggg && bundle add hello-world-testingggg --source 'https://pkg.stainless.com/s/hello-world-testingggg-ruby/$SHA'\033[0m"
