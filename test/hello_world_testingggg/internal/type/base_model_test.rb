...
class HelloWorldTestingggg::Test::PrimitiveModelTest < Minitest::Test
  A = HelloWorldTestingggg::Internal::Type::ArrayOf[-> { Integer }]
  H = HelloWorldTestingggg::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < HelloWorldTestingggg::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      ...
      HelloWorldTestingggg::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => HelloWorldTestingggg::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [HelloWorldTestingggg::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [HelloWorldTestingggg::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [HelloWorldTestingggg::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = HelloWorldTestingggg::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        HelloWorldTestingggg::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [HelloWorldTestingggg::Internal::Type::Boolean, true] => true,
      [HelloWorldTestingggg::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => HelloWorldTestingggg::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        HelloWorldTestingggg::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = HelloWorldTestingggg::Internal::Type::Converter.new_coerce_state
      HelloWorldTestingggg::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        HelloWorldTestingggg::Internal::Type::Converter.dump(target, input, state: state)
...
class HelloWorldTestingggg::Test::EnumModelTest < Minitest::Test
  class E0
    include HelloWorldTestingggg::Internal::Type::Enum
...
class HelloWorldTestingggg::Test::CollectionModelTest < Minitest::Test
  A1 = HelloWorldTestingggg::Internal::Type::ArrayOf[-> { Integer }]
  H1 = HelloWorldTestingggg::Internal::Type::HashOf[Integer]

  A2 = HelloWorldTestingggg::Internal::Type::ArrayOf[H1]
  H2 = HelloWorldTestingggg::Internal::Type::HashOf[-> { A1 }]

  A3 = HelloWorldTestingggg::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = HelloWorldTestingggg::Internal::Type::HashOf[Integer, nil?: true]
...
class HelloWorldTestingggg::Test::BaseModelTest < Minitest::Test
  class M1 < HelloWorldTestingggg::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < HelloWorldTestingggg::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < HelloWorldTestingggg::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, HelloWorldTestingggg::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = HelloWorldTestingggg::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = HelloWorldTestingggg::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(HelloWorldTestingggg::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue HelloWorldTestingggg::Errors::ConversionError => e
...
class HelloWorldTestingggg::Test::UnionTest < Minitest::Test
  class U0
    include HelloWorldTestingggg::Internal::Type::Union
  ...
  class M2 < HelloWorldTestingggg::Internal::Type::BaseModel
  ...
  class M4 < HelloWorldTestingggg::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, HelloWorldTestingggg::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < HelloWorldTestingggg::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, HelloWorldTestingggg::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class HelloWorldTestingggg::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include HelloWorldTestingggg::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [HelloWorldTestingggg::Internal::Type::Unknown, HelloWorldTestingggg::Internal::Type::Unknown] => true,
      [HelloWorldTestingggg::Internal::Type::Boolean, HelloWorldTestingggg::Internal::Type::Boolean] => true,
      [HelloWorldTestingggg::Internal::Type::Unknown, HelloWorldTestingggg::Internal::Type::Boolean] => false,
...
class HelloWorldTestingggg::Test::MetaInfoTest < Minitest::Test
  A1 = HelloWorldTestingggg::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = HelloWorldTestingggg::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
