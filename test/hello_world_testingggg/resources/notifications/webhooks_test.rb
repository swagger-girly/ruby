...
class HelloWorldTestingggg::Test::Resources::Notifications::WebhooksTest < HelloWorldTestingggg::Test::ResourceTest
  def test_parse_pet
    ...
    @hello_world_testingggg.notifications.webhooks.parse_pet(data, headers: headers, key: key)
    ...
    bad_headers.each do |bad_header|
      assert_raises(StandardWebhooks::WebhookVerificationError) do
        @hello_world_testingggg.notifications.webhooks.parse_pet(data, headers: bad_header, key: key)
      end
    end
  end
end
