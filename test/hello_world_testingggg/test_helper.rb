...
class HelloWorldTestingggg::Test::SingletonClient < HelloWorldTestingggg::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: HelloWorldTestingggg::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class HelloWorldTestingggg::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @hello_world_testingggg = HelloWorldTestingggg::Test::SingletonClient.instance
  end
